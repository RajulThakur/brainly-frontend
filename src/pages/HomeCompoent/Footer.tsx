    ...
    <footer className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
        ...
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center gap-2">
            <Logo varient="md" />
            <span className="text-xl font-bold text-gray-900">Linkcaddy</span>
          </div>
          <p className="mt-4 text-sm text-gray-600">
            Your second brain for the web. Save, organize, and share content
            effortlessly.
          </p>
      ...
      <div className="mt-8 border-t border-gray-200 pt-8">
        <p className="text-base text-gray-400">
          &copy; {new Date().getFullYear()} Linkcaddy. All rights reserved.
        </p>
      </div>
    </footer>
  );
